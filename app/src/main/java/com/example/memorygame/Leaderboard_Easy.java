...
public class Leaderboard_Easy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaderboard_easy);
        ...
        hmbtn.setOnClickListener(v1 -> {
            Intent homeIntent = new Intent(Leaderboard_Easy.this, MainActivity.class);
        ...
        deleteBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(Leaderboard_Easy.this, "Data deleted", Toast.LENGTH_SHORT).show();
        });
    }
