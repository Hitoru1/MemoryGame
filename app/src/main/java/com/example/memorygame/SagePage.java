...
public class SagePage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_sage_page);
        ...
        brimBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, CardCatalogPage.class);
        ...
        chamBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, ChamPage.class);
                startActivity(intent);
            }
        });
        ...
        cloveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, ClovePage.class);
                startActivity(intent);
            }
        });
        ...
        gekkoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, GekkoPage.class);
                startActivity(intent);
            }
        });
        ...
        isoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, IsoPage.class);
                startActivity(intent);
            }
        });
        ...
        jettBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, JettPage.class);
                startActivity(intent);
            }
        });
        ...
        omenBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, OmenPage.class);
                startActivity(intent);
            }
        });
        ...
        skyeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, SkyePage.class);
                startActivity(intent);
            }
        });
        ...
        sovaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, SovaPage.class);
                startActivity(intent);
            }
        });
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SagePage.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
