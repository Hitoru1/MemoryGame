...
public class IsoPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_iso_page);
        ...
        brimBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, CardCatalogPage.class);
        ...
        chamBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, ChamPage.class);
                startActivity(intent);
            }
        });
        ...
        cloveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, ClovePage.class);
                startActivity(intent);
            }
        });
        ...
        gekkoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, GekkoPage.class);
                startActivity(intent);
            }
        });
        ...
        jettBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, JettPage.class);
                startActivity(intent);
            }
        });
        ...
        omenBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, OmenPage.class);
                startActivity(intent);
            }
        });
        ...
        sageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, SagePage.class);
                startActivity(intent);
            }
        });
        ...
        skyeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, SkyePage.class);
                startActivity(intent);
            }
        });
        ...
        sovaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, SovaPage.class);
                startActivity(intent);
            }
        });
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IsoPage.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
