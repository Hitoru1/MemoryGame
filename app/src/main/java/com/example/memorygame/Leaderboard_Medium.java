...
public class Leaderboard_Medium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hmbtn.setOnClickListener(v1 -> {
            Intent homeIntent = new Intent(Leaderboard_Medium.this, MainActivity.class);
        ...
        deleteBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(Leaderboard_Medium.this, "Data deleted", Toast.LENGTH_SHORT).show();
        });
    }
