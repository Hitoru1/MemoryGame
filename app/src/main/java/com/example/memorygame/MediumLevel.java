...
public class MediumLevel extends AppCompatActivity {
    ...
    private long timeLeftInMillis = 70000; // 30 seconds
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bckbutton.setOnClickListener(v -> {
            Intent mainActivityIntent = new Intent(MediumLevel.this, MainActivity.class);
        ...
        pauseButton.setOnClickListener(v -> {
            ...
            LayoutInflater inflater = LayoutInflater.from(MediumLevel.this);
            View popupView = inflater.inflate(R.layout.popup_pause_medium, null);

            AlertDialog.Builder builder = new AlertDialog.Builder(MediumLevel.this);
            ...
            hmbtn.setOnClickListener(v1 -> {
                Intent homeIntent = new Intent(MediumLevel.this, MainActivity.class);
    ...
    private void showTimeoutDialog() {
        ...
        View view = inflater.inflate(R.layout.timeout_popup_medium, null);
    ...
    private void showWinDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(MediumLevel.this);
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.youwin_popup_medium, null);
        ...
        closebutton.setOnClickListener(v1 -> {
            Intent closeIntent = new Intent(MediumLevel.this, MainActivity.class);
    ...
    private void saveToLeaderboard(String name, int flips, int timeLeft) {
        SharedPreferences prefs = getSharedPreferences("Leaderboard_Medium", MODE_PRIVATE);
