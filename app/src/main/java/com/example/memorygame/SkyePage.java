...
public class SkyePage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_skye_page);
        ...
        brimBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, CardCatalogPage.class);
        ...
        chamBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, ChamPage.class);
                startActivity(intent);
            }
        });
        ...
        cloveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, ClovePage.class);
                startActivity(intent);
            }
        });
        ...
        gekkoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, GekkoPage.class);
                startActivity(intent);
            }
        });
        ...
        isoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, IsoPage.class);
                startActivity(intent);
            }
        });
        ...
        jettBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, JettPage.class);
                startActivity(intent);
            }
        });
        ...
        omenBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, OmenPage.class);
                startActivity(intent);
            }
        });
        ...
        sageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, SagePage.class);
                startActivity(intent);
            }
        });
        ...
        sovaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, SovaPage.class);
                startActivity(intent);
            }
        });
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SkyePage.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
