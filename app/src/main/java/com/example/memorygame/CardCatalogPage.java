...
public class CardCatalogPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_card_catalog_page);
        ...
        chamBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, ChamPage.class);
        ...
        cloveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, ClovePage.class);
                startActivity(intent);
            }
        });
        ...
        gekkoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, GekkoPage.class);
                startActivity(intent);
            }
        });
        ...
        isoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, IsoPage.class);
                startActivity(intent);
            }
        });
        ...
        jettBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, JettPage.class);
                startActivity(intent);
            }
        });
        ...
        omenBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, OmenPage.class);
                startActivity(intent);
            }
        });
        ...
        sageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, SagePage.class);
                startActivity(intent);
            }
        });
        ...
        skyeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, SkyePage.class);
                startActivity(intent);
            }
        });
        ...
        sovaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, SovaPage.class);
                startActivity(intent);
            }
        });
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CardCatalogPage.this, MainActivity.class);
                startActivity(intent);
            }
        });
