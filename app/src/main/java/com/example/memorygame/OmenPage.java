...
public class OmenPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_omen_page);
        ...
        brimBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, CardCatalogPage.class);
        ...
        chamBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, ChamPage.class);
                startActivity(intent);
            }
        });
        ...
        cloveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, ClovePage.class);
                startActivity(intent);
            }
        });
        ...
        gekkoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, GekkoPage.class);
                startActivity(intent);
            }
        });
        ...
        isoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, IsoPage.class);
                startActivity(intent);
            }
        });
        ...
        jettBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, JettPage.class);
                startActivity(intent);
            }
        });
        ...
        sageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, SagePage.class);
                startActivity(intent);
            }
        });
        ...
        skyeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, SkyePage.class);
                startActivity(intent);
            }
        });
        ...
        sovaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, SovaPage.class);
                startActivity(intent);
            }
        });
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OmenPage.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
